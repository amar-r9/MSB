...
public class MsbUtil {
	...
	public static int getCompetitionCategoryID(String categoryName) {
		...
		if ("drama".equalsIgnoreCase(categoryName))
			return MsbConstants.DRAMA_COMPETITION;
		if ("photography".equalsIgnoreCase(categoryName))
			return MsbConstants.PHOTOGRAPHY_COMPETITION;
		if ("story".equalsIgnoreCase(categoryName))
			return MsbConstants.STORYTELLING_COMPETITION;
		if ("comedystars".equalsIgnoreCase(categoryName))
			return MsbConstants.COMEDYSTARS_COMPETITION;
	...
	public static String buildTestMail(String subject) {
		String body = "<div dir='ltr'>"
				...
				+ "<b><font size='4'><br></font></b>"
				+ "<h3>Dear user, </h3>"
				+ "<h4>Your account has been loggid in.</h4>"
				+ "<i><font color='#ff0000'>My</font>"
				+ "<font color='#00ff00'>Super</font><font color='#0000ff'>Brain</font></h3>"
				+ "<h4><br></font></h4>"
				+ "<b><br></b><br>"
				+ "<br><br><br>"
				+ "<a href='https://www.mysuperbrain.in/school/premium-services'>"
				+ "<img src='https://mysuperbrain.in/img/mail/Premiumaccounthook.png' width='417' height='436' class='CToWUd a6T' tabindex='0'></a>"
				+ "</div>"
				+ "<h3>All the best !</h3>"
				+ "<p>Thanks & Regards,</p>"
