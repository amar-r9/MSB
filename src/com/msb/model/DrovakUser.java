...
@Entity
@Table(name = "DROVAK_USER")
@SecondaryTables({
		@SecondaryTable(name = "DROVAK_IMAGE", pkJoinColumns = { @PrimaryKeyJoinColumn(name = "id", referencedColumnName = "id") }) })
public class DrovakUser implements Serializable {
	...
	@Required
	@UsernameExistConstraint(groups = { SaveUser.class }, message = "UserName Exist.Please choose another")
