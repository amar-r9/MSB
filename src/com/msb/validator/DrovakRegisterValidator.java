...
@Component
public class DrovakRegisterValidator implements Validator {
	
	@Autowired
	private SchoolympicsService drovakService;

	@Override
	public boolean supports(Class<?> clazz) {
		return DrovakUser.class.equals(clazz);
	}

	@Override
	public void validate(Object target, Errors errors) {

		DrovakUser user = (DrovakUser) target;
	...
	public void validate1(Object target, Errors errors) {
		...
		DrovakUser user1 = (DrovakUser) target;
