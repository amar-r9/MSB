...
public class EntrepreneurUserAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null || otherData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/entrepreneur/login?invalidsession=true&next="+nextURL);
			return false;
		}
