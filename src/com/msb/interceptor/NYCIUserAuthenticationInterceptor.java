...
public class NYCIUserAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/nyci/login?invalidsession=true&next="+nextURL);
			return false;
		}
