...
public class UrbaneUserAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/nac/login?invalidsession=true&next="+nextURL);
			return false;
		}
