...
public class SrichaitanyaUserAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/srichaitanya/login?invalidsession=true&next="+nextURL);
			return false;
		}
