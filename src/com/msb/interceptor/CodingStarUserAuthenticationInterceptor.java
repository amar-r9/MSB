...
public class CodingStarUserAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/codingstar/login?invalidsession=true&next="+nextURL);
			return false;
		}
