...
public class LotusUserAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/lotus/login?invalidsession=true&next="+nextURL);
			return false;
		}
