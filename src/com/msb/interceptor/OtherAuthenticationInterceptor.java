...
public class OtherAuthenticationInterceptor extends HandlerInterceptorAdapter {
	...
	public boolean preHandle(HttpServletRequest request,
		...
		if(userData!=null){
			...
			response.sendRedirect(request.getContextPath()+"/others/login?invalidsession=true&next="+nextURL);
			return false;
		}
