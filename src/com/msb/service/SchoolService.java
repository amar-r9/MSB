...
public interface SchoolService {
	...
	public School getSchoolPageDeails(int id);

	public String getSchoolImage(int id);

	public String getSchoolLogo(int id);

	public Integer getSchoolTotalPoints(String school_name, String schoolcode);

	public List<SchoolUser> getSchoolToppers(String school_name, String schoolcode, int limit);
	
	public List<CompetitionText> getSchoolTextEntries(String school_name,String school_code,int textCategory,int limit,int offset);
