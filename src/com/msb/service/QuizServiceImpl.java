...
public class QuizServiceImpl implements QuizService {
	...
	public Quiz getQuizByName(String id) {
		...
		return quizDAO.getQuizByName(id);
	}
	...
	public List<Quiz> getQuizzesForClient(String client) {
		...
		return quizDAO.getQuizzesForClient(client);
	}
	
	@Override
	public QuizScores getQuizResult(String id, String username) {
		return quizDAO.getQuizResult(id, username);
	}

	@Override
	public String getStudentName(String user) {
		return quizDAO.getStudentName(user);
	}
