...
public class SingerHomeController {
	...
	@RequestMapping(value = "/singer/rules", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/singer/premium", method = RequestMethod.GET)
	public ModelAndView singerPremium(HttpSession session) {
		...
		//if (userData != null) {
			...
			//}
			modelAndView.setViewName("/singer/premium");
			return modelAndView;
		//} else
	...
	public ModelAndView getCompetitions() {
		...
		if (competitions != null && competitions.size() > 0) {
			...
			modelAndView.setViewName("/singer/competition_list");
			return modelAndView;
		} else{
			
				return new ModelAndView("redirect:/singer/list?success=false&cat=Music");
		}
