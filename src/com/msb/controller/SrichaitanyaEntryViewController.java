...
@Controller
public class SrichaitanyaEntryViewController {
	...
	@RequestMapping(value = "/srichaitanya/view/text_competition/{id}", method = RequestMethod.GET)
	public ModelAndView textCompetitionEntryView(@PathVariable("id") String id) {
		...
		modelAndView.setViewName("/srichaitanya/entries/view_text_competition");
		return modelAndView;

	}

	@RequestMapping(value = "/srichaitanya/view/mst_competition/{id}", method = RequestMethod.GET)
	public ModelAndView mstCompetitionEntryView(
		...
		modelAndView.setViewName("/srichaitanya/entries/view_mst_competition");
		return modelAndView;

	}

	@RequestMapping(value = "/srichaitanya/view/uat_competition/{id}", method = RequestMethod.GET)
	public ModelAndView uatCompetitionEntryView(@PathVariable("id") String id) throws IOException {
		...
		modelAndView.setViewName("/srichaitanya/entries/view_uat_competition");
		return modelAndView;

	}
	
	@RequestMapping(value = "/srichaitanya/text_entries/{type}/{limit}/{offset}", method = RequestMethod.GET)
	public ModelAndView texttEntries(@PathVariable String type, @PathVariable int limit, 
		...
		modelAndView.setViewName("/srichaitanya/entries/text_entries");
		return modelAndView;
	}
	
	@RequestMapping(value = "/srichaitanya/mst_entries/{type}/{limit}/{offset}", method = RequestMethod.GET)
	public ModelAndView mstEntries(@PathVariable String type, @PathVariable int limit, 
		...
		modelAndView.setViewName("/srichaitanya/entries/mst_entries");
		return modelAndView;
	}
	
	@RequestMapping(value = "/srichaitanya/uat_entries/{limit}/{offset}", method = RequestMethod.GET)
	public ModelAndView texttEntries(@PathVariable int limit, 
		...
		modelAndView.setViewName("/srichaitanya/entries/uat_entries");
		return modelAndView;
	}
	
	@RequestMapping(value = "/srichaitanya/user/edit/mst_entry/{id}", method = RequestMethod.GET)
	public ModelAndView mstCompetitionEntryEdit(
		...
		modelAndView.setViewName("/srichaitanya/entries/edit_mst_entry");
		return modelAndView;
