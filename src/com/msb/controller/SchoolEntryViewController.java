...
@Controller
public class SchoolEntryViewController {
	...
	@RequestMapping(value = "/school/view/text_competition/{id}", method = RequestMethod.GET)
	public ModelAndView textCompetitionEntryView(@PathVariable("id") String id) {
		...
		modelAndView.setViewName("/school/entries/view_text_competition");
		return modelAndView;

	}

	
	@RequestMapping(value = "/school/view/mst_competition/{id}", method = RequestMethod.GET)
	public ModelAndView mstCompetitionEntryView(
		...
		modelAndView.setViewName("/school/entries/view_mst_competition");
		return modelAndView;

	}

	@RequestMapping(value = "/school/view/uat_competition/{id}", method = RequestMethod.GET)
	public ModelAndView uatCompetitionEntryView(@PathVariable("id") String id) throws IOException {
		...
		modelAndView.setViewName("/school/entries/view_uat_competition");
		return modelAndView;

	}
	
	@RequestMapping(value = "/school/text_entries/{type}/{limit}/{offset}", method = RequestMethod.GET)
	public ModelAndView texttEntries(@PathVariable String type, @PathVariable int limit, 
		...
		modelAndView.setViewName("/school/entries/text_entries");
		return modelAndView;
	}
	
	@RequestMapping(value = "/school/mst_entries/{type}/{limit}/{offset}", method = RequestMethod.GET)
	public ModelAndView mstEntries(@PathVariable String type, @PathVariable int limit, 
		...
		modelAndView.setViewName("/school/entries/mst_entries");
		return modelAndView;
	}
	
	@RequestMapping(value = "/school/uat_entries/{limit}/{offset}", method = RequestMethod.GET)
	public ModelAndView texttEntries(@PathVariable int limit, 
		...
		modelAndView.setViewName("/school/entries/uat_entries");
		return modelAndView;
	}
