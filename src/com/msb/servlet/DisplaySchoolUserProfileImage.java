 ...
 */
@WebServlet("/resources/DisplaySchoolUserProfileImage")
public class DisplaySchoolUserProfileImage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public DisplaySchoolUserProfileImage() {
		super();
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			SchoolUser other = (SchoolUser) httpSession.getAttribute("SchoolStudent");
