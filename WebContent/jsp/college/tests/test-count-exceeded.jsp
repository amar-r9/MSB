...
<meta charset="utf-8" />
<title>Student Test Count Exceeded for the day | MySuperBrain.com</title>
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Test<small> <i
									class="ace-icon fa fa-angle-double-right"></i> Number of tests per day exceeded
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								<h3>Only premium user can attempt more than 3 tests in a day</h3>
								<!-- <h3>Sorry..! You can not attempt more than 3 tests per day as you are not a premium user.</h3> -->
								<h4>Please register for premium account for yearly fee of INR 500/-</h4>
								<p>&nbsp;</p>
								<a class="col-md-6 col-md-offset2 btn btn-success btn-block" href="<%=request.getContextPath()%>/premium-services">SUBSCRIBE TO PREMIUM SERVICES</a>
							</div>
							<!-- /.col -->
						</div>
						<!-- /.row -->
