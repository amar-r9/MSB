...
<meta charset="utf-8" />
<title>Top Schools | MySuperBrain.com</title>
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
						 <a href="<%=request.getContextPath() %>/school/all-list" class="pull-right">View Full List</a>
							<h1>
								Top schools<small> <i
									class="ace-icon fa fa-angle-double-right"></i>List of top schools 
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
							...
							<table id="top-schools"
								...
								<thead>
									<tr role="row">
										...
										<th class="sorting" tabindex="0" aria-controls="top-schools"
											rowspan="1" colspan="1"
											aria-label="school: activate to sort column ascending">Total 
											Points</th>	
