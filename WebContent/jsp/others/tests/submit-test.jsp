...
<meta charset="utf-8" />
<title>Quiz Submission | MySuperBrain.com</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Test Submission</li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Submission<small> <i
									class="ace-icon fa fa-angle-double-right"></i> Your Test submitted successfully
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								...
								<p>&nbsp;</p>
								<a href="<%=request.getContextPath() %>/premium-services" class="btn btn-success btn-block">CLICK HERE FOR PREMIUM SERVICES</a>
							</div>
							<!-- /.col -->
						</div>
						<!-- /.row -->
