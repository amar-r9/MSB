                ...
                <div class="h-100 no-gutters row">
                            ...
                            <div class="slick-slider">
                                <div>
                                    <div class="position-relative h-100 d-flex justify-content-center align-items-center bg-plum-plate" tabindex="-1">
                                        ...
                                        <div class="slider-content"><h3>Entrepreneur</h3>
                                            <p>You will know what it takes to build a great business, the skills you need, motivation behind some successful entrepreneurs, amazing stories of grit & determination and how to identify problems & opportunities to build business. You have to prepare today to be successful tomorrow.</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="h-100 d-flex bg-white justify-content-center align-items-center col-md-12 col-lg-8">
                        <div class="mx-auto app-login-box col-sm-12 col-md-10 col-lg-9">
                            ...
                            <h6 class="mt-3">No account? <a href="<%=request.getContextPath() %>/entrepreneur/register" class="text-primary">Sign up now</a></h6>
                            ...
                            <div>
                                <form:form method="POST" action="../entrepreneur/validateLogin"
