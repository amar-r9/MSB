...
<div class="app-header header-shadow">
	<div class="app-header__logo">
		...
		<!-- <h2 style="font-weight: 600; color: #4471f1;">MySuperTalent</h2> -->
	...
	<div class="app-header__content">
		<div class="app-header-left">
			<ul class="header-menu nav">
				<li class="nav-item"><a href="<%=request.getContextPath()%>/others/user/upload_a_talent"
					class="nav-link"> <i class="nav-link-icon pe-7s-diamond">
					</i> Upload A Talent
				</a></li>
				<li class="btn-group nav-item"><a href="<%=request.getContextPath()%>/others/competitions"
					class="nav-link"> <i class="nav-link-icon pe-7s-graph3"></i>
						Competitions
				</a></li>
				<li class="dropdown nav-item"><a href="<%=request.getContextPath()%>/others/viewentries"
		...
		<div class="app-header-right">
						...
						<div class="dropdown-menu-header">
							<div class="dropdown-menu-header-inner pt-4 pb-4 bg-focus">
								<div class="menu-header-image opacity-05">
									<i class="fa fa-users-cog icon-gradient bg-tempting-azure fa fa-2x"></i></div>
													...
													<div class="widget-content p-0">
														<div class="widget-content-wrapper">
															...
															<div class="widget-content-right mr-2">
																<a href="<%=request.getContextPath()%>/others/logout"
			...
			<c:if test="${empty Other}">
				<a href="<%=request.getContextPath()%>/others/login" class="btn btn-warning"
					style="border-radius: 50px; height: 45px; width: 45px;">
					<i class="fa fa-key fa-w-16 fa-2x" style="line-height: 1.2em;"></i>
				</a>
				
				<%-- 
				<a href="<%=request.getContextPath()%>/others/register">
