...
<meta charset="utf-8" />
<title>No Javascript | MySuperBrain.com</title>
			...
			<div class="main-content-inner">
				...
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Javascript Disabled</li>
					</ul>
					<!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="page-header">
							<h1>
								Script Error<small> <i
									class="ace-icon fa fa-angle-double-right"></i> Javascript is disabled 
								</small>
							</h1>
						</div>
						<!-- /.page-header -->
						<div class="row">
							<div class="col-md-12">	
								<h3>Please enable javascript support for the browser to continue further. Thank you</h3>
							</div>
							<!-- /.col -->
						</div>
						<!-- /.row -->
