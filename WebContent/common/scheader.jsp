...
<div class="app-header header-shadow">
	<div class="app-header__logo">
		...
		<img src="<%=request.getContextPath() %>/img/sc1112.jpeg" style="height: 50px;"/>
	...
	<div class="app-header__content">
		...
		<a href="<%=request.getContextPath()%>/srichaitanya"><img src="<%=request.getContextPath() %>/img/images.png" /></a>
			<ul class="header-menu nav" style="/* padding-left: 100px; */ TEXT-TRANSFORM: UPPERCASE;">
				...
				<c:if test="${not empty SchoolStudent}">
					<c:choose>
						<c:when test="${SchoolStudent.getPremium() eq 1 }">
							<li class="nav-item"><a href="<%=request.getContextPath()%>/srichaitanya/premium/articles/all/0"
								class="nav-link"> <i class="nav-link-icon pe-7s-news-paper"></i>
									Blog
							</a></li>
							<li class="nav-item"><a href="<%=request.getContextPath()%>/srichaitanya/user/premium/courses"
								class="nav-link"> <i class="nav-link-icon pe-7s-bookmarks"></i>
									Courses
							</a></li>
						</c:when>
						<c:otherwise>
							<li class="nav-item"><a href="#"
								class="nav-link" data-toggle="modal" data-target="#premiumBlog"> <i class="nav-link-icon pe-7s-news-paper"></i>
									Blog
							</a></li>
							<li class="nav-item"><a href="#" data-toggle="modal" data-target="#premiumBlog"
								class="nav-link"> <i class="nav-link-icon pe-7s-bookmarks"></i>
									Courses
							</a></li>
						</c:otherwise>
				...
				<c:if test="${empty SchoolStudent}">
					<li class="nav-item"><a href="<%=request.getContextPath()%>/srichaitanya/login"
					class="nav-link"> <i class="nav-link-icon pe-7s-news-paper"></i>
						Blog
					</a></li>
					<li class="nav-item"><a href="<%=request.getContextPath()%>/srichaitanya/login"
		...
		<div class="app-header-right">
			...
			<c:if test="${not empty SchoolStudent}">
				<div class="header-btn-lg pr-0" style="margin-left: 0;">
											...
											<div class="scrollbar-container ps ps--active-y">
												<ul class="nav flex-column">
													...
													<li class="nav-item"><a href="<%=request.getContextPath() %>/srichaitanya/user/changepwd" class="nav-link">Change
															Password </a></li>
													<li class="nav-item"><a href="<%=request.getContextPath() %>/srichaitanya/premium" class="nav-link">Premium </a></li>
...
<%-- <c:if test="${not empty SchoolStudent }">
	<c:if test="${SchoolStudent.getPremium() eq 0 }">
		...
		<button type="button" class="btn mr-2 mb-2 btn-primary hide" data-toggle="modal" data-target="#exampleModal1"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">UPGRADE TO PREMIUM</h5>
...
<div class="modal fade" id="premiumBlog" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Premium Content</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p class="mb-0">This functionality is only accessible to Premium Accounts.</p>
            </div>
            <div class="modal-footer">
