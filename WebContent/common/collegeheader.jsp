...
<div class="app-header header-shadow">
	<div class="app-header__logo">
		...
		<span style="font-family: MV Boli; color: #ff2300;">College</span>
	...
	<div class="app-header__content">
		<div class="app-header-left">
			<ul class="header-menu nav">
				<li class="nav-item"><a href="<%=request.getContextPath()%>/college/user/upload_a_talent"
					class="nav-link"> <i class="nav-link-icon pe-7s-diamond">
					</i> Upload A Talent
				</a></li>
				<%-- <li class="btn-group nav-item"><a href="<%=request.getContextPath()%>/college/competitions"
					class="nav-link"> <i class="nav-link-icon pe-7s-graph3"></i>
						Competitions
				</a></li> --%>
				<li class="dropdown nav-item"><a href="<%=request.getContextPath()%>/college/viewentries"
		...
		<div class="app-header-right">
			...
			<c:if test="${not empty CollegeStudent}">
							...
							<div class="widget-content-left">
								<div class="btn-group">
									<a data-toggle="dropdown" aria-haspopup="true"
										...
										src="<%=request.getContextPath()%>/resources/DisplayCollegeUserProfileImage"
												...
												<div class="menu-header-content text-left">
													<div class="widget-content p-0">
														<div class="widget-content-wrapper">
															...
															<div class="widget-content-left">
																<div class="widget-heading">${CollegeStudent.username}</div>
																<!-- <div class="widget-subheading opacity-8">A short profile description
                                                                </div> -->
															</div>
															<div class="widget-content-right mr-2">
																<a href="<%=request.getContextPath()%>/college/logout"
												...
												<ul class="nav flex-column">
													...
													<li class="nav-item"><a href="javascript:void(0);"
														class="nav-link">Points
															<div class="ml-auto badge badge-pill badge-info">${CollegeStudent.points }
															</div>
													</a></li>
											...
											<div class="no-gutters row">
												<div class="col-sm-6">
													<a
														...
														href="<%=request.getContextPath()%>/college/user/profile">
														<i
			...
			<c:if test="${empty CollegeStudent}">
				<a href="<%=request.getContextPath()%>/college/login" class="btn btn-warning"
					style="border-radius: 50px; height: 45px; width: 45px;">
					<i class="fa fa-key fa-w-16 fa-2x" style="line-height: 1.2em;"></i>
				</a>
				<%-- 
				<a href="<%=request.getContextPath()%>/college/register">
