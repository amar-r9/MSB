		...
		<span>
			<c:choose>
				<c:when test="${empty SchoolStudent && empty Other}">
					<a href="<%=request.getContextPath()%>/singer/login" class="btn btn-warning">
	...
	<div class="app-header__content">
		<div class="app-header-left">
			<ul class="header-menu nav" style="padding-left: 200px;">
				<li class="nav-item"><a href="<%=request.getContextPath()%>/riyaz"
					class="nav-link"> <i class="nav-link-icon pe-7s-music">
					</i> Riyaz
				</a></li>
				<li class="nav-item"><a href="<%=request.getContextPath()%>/singer/user/upload_singing/18"
					class="nav-link"> <i class="nav-link-icon pe-7s-music">
					</i> Upload Your Entry
				</a></li>
				...
				<%-- <li class="dropdown nav-item"><a href="<%=request.getContextPath()%>/singer/viewentries"
					class="nav-link"> <i class="nav-link-icon pe-7s-search"></i>
						Entries
				</a></li> --%>
				<c:if test="${empty SchoolStudent && empty Other}">
				<li>
				<a href="<%=request.getContextPath()%>/singer/register" class="btn btn-info">
					<!-- <i class="fa fa-key fa-w-16 fa-2x" style="line-height: 1.2em;"></i> -->
					REGISTER
				</a></li>
														...
														<div class="widget-content p-0">
															<div class="widget-content-wrapper">
																...
																<div class="widget-content-right mr-2">
																	<a href="<%=request.getContextPath()%>/singer/slogout"
													...
													<div class="menu-header-content text-left">
														<div class="widget-content p-0">
															<div class="widget-content-wrapper">
																...
																<div class="widget-content-right mr-2">
																	<a href="<%=request.getContextPath()%>/singer/ologout"
																		class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
																	</a>
																</div>
															</div>
