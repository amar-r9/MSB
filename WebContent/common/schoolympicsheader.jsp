	...
	<div class="app-header__content">
		<div class="app-header-left">
			<ul class="header-menu nav">
				<li class="nav-item"><a href="<%=request.getContextPath()%>/schoolympics"
					class="nav-link"> 
					</i> Home
				</a></li>
				<li class="nav-item"><a href="<%=request.getContextPath()%>/schoolympics/user/upload_a_talent"
					class="nav-link"> 
					</i> Showcase Talent
				</a></li>
				<li class="nav-item"><a href="<%=request.getContextPath()%>/schoolympics/competitions"
					class="nav-link"> 
						Competitions
				</a></li>
				...
				<a href="<%=request.getContextPath()%>/schoolympics/login" class="btn btn-success btn-square">
															...
															<div class="widget-content-right mr-2">
																<c:choose>
																	<c:when test="${SchoolStudent.socialLogin eq 1 }">
																		<a href="<%=request.getContextPath()%>/schoolympics/googlelogout"
																			class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
																		</a>
																	</c:when>
																	<c:otherwise>
																		<a href="<%=request.getContextPath()%>/schoolympics/logout"
																			class="btn-pill btn-shadow btn-shine btn btn-focus">Logout
																		</a>
																	</c:otherwise>
																</c:choose>
