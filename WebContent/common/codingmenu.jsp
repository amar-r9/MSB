		...
		<div class="scrollbar-sidebar">
			<div class="app-sidebar__inner">
				<ul class="vertical-nav-menu">
					...
					<li><a href="<%=request.getContextPath()%>/" id="home">
							<i class="metismenu-icon pe-7s-home"></i> HOME
					</a></li>
					<li><a
						href="<%=request.getContextPath()%>/codingstar/user/tests"
						id="uploadtalent"> <i class="metismenu-icon pe-7s-diamond"></i>
							Participate
					</a></li>
					<li><a href="<%=request.getContextPath()%>/codingstar/studenthof">
						<i class="metismenu-icon fa fa-bars"></i>Leader Board
				</a></li>
					...
					<%-- <li><a
						href="<%=request.getContextPath()%>/entrepreneur/user/blog"
						id="entries"> <i class="metismenu-icon pe-7s-file"></i>COURSES
					</a></li> --%>
