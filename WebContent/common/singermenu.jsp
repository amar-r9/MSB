		...
		<div class="scrollbar-sidebar">
			<div class="app-sidebar__inner">
				<ul class="vertical-nav-menu">
					...
					<li><a href="<%=request.getContextPath()%>/singer" id="home">
							<i class="metismenu-icon pe-7s-home"></i> Home
					</a></li>
					<li><a
						href="<%=request.getContextPath()%>/singer/user/upload_singing/18"
						id="uploadtalent"> <i class="metismenu-icon pe-7s-music"></i>
							Upload Your Singing
					</a></li>
					<%-- <li><a
